...
public class CustomerSearchAdapter extends ArrayAdapter<CustomerListData> {
    private List<CustomerListData> customerListFull;

    public CustomerSearchAdapter(Activity context, ArrayList<CustomerListData> customerList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    R.layout.customer_search_items, parent, false
            );
        }
        ...
        TextView textMobile = convertView.findViewById(R.id.txt_mobile_number);
        ...
        if (customerItem != null) {
            ...
            textMobile.setText(customerItem.getMobile());
            textEmail.setText(customerItem.getEmail());
